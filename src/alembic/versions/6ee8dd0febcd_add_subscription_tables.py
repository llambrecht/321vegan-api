...
def upgrade() -> None:
    ...
    sa.Column('platform', sa.Enum('APPLE', 'GOOGLE', name='subscriptionplatform'), nullable=False),
    ...
    sa.Column('event_type', sa.Enum('INITIAL_PURCHASE', 'RENEWAL', 'CANCELLATION', 'EXPIRY', 'REFUND', 'GRACE_PERIOD', name='subscriptioneventtype'), nullable=False),
